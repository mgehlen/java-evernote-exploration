...
class EDAMDemo {
     ...
     * Console entry point.
     */
    public static void main(String args[]) throws TException, EDAMNotFoundException {
     ...
     */
    private void listNotes() throws TException, EDAMUserException, EDAMSystemException, EDAMNotFoundException {
        ...
        for (Notebook notebook : notebooks) {
            System.out.println("Notebook: " + notebook.getName() + " GUID: " + notebook.getGuid());
            ...
            System.out.println("Note Counts: " + noteCollectionCounts.getNotebookCounts().get(notebook.getGuid()).toString()) ;
